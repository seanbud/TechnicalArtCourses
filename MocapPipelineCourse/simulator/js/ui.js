...
function renderInspector() {
  ...
  if (t === "data") {
    if (S.selectedFile && stadium_project[S.selectedFile]) {
      body.innerHTML = '<div class="inspector-label">File: ' + S.selectedFile + '</div>' + highlightPy(stadium_project[S.selectedFile]);
    } else if (S.packet) {
    ...
    var hooks = c.plugin === "stadium_custom" ? ["register","custom_retarget"] : ["register","pre_export","post_export","custom_validate"];
