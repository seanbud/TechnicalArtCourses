...
const CLIENT_CONFIGS = {
  stadium: {
    ...
    naming: { pattern: "^ST_\\d{8}_sc\\d+_sh\\d+_v\\d{3}$", example: "ST_20260228_sc01_sh05_v001" },
    export: { format: "fbx", fbx_version: "FBX202000", up_axis: "y", units: "cm", bake_animation: true },
    delivery: { method: "perforce", depot_path: "//depot/stadium/mocap/", slack_channel: "#stadium-mocap-delivery" },
  ...
  action_project: {
    ...
    naming: { pattern: "^AC_[a-zA-Z0-9]+_[a-zA-Z]+$", example: "AC_actor01_sprint" },
    export: { format: "fbx", fbx_version: "FBX201900", up_axis: "y", units: "cm", bake_animation: true },
    delivery: { method: "perforce", depot_path: "//depot/action/anim/raw/", slack_channel: "#action-pipeline" },
...
```json
{
  "take_name": "ST_20260228_sc01_sh05",
  "frame_rate": 120.0,
  "frame_count": 3450,
...
{
  "...": "all previous fields +",
  "target_skeleton": "Athlete_Humanoid_v3",
  "joints_remapped": true,
  "joints": "{ 18 joints (target skeleton) }",
  "joint_map_used": "maps/stadium_joint_map.json"
}
```
...
```json
{
  "...": "all previous fields +",
  "validation_results": [
    { "checker": "naming", "passed": true, "message": "Matches ^ST_\\d{8}..." },
...
```json
{
  ...
  "delivery_destination": "//depot/stadium/mocap/ST_20260228_sc01_sh05_v001.fbx",
  "delivery_md5": "a1b2c3d4e5f6...",
  "delivery_timestamp": "2026-02-28T14:23:45",
  "notification_sent": "#stadium-mocap-delivery"
}
```
